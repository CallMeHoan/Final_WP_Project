...
{
    public partial class EditClick : Form
    {
        public EditClick()
        {
            InitializeComponent();
        ...
        private void date_cb_Enter_1(object sender, EventArgs e)
        {
        ...
        private void date_cb_Leave_1(object sender, EventArgs e)
        {
            if (date_cb.Text == "")
            {
                date_cb.Text = "Date";
        ...
        private void month_cb_Enter_1(object sender, EventArgs e)
        {
        ...
        private void month_cb_Leave_1(object sender, EventArgs e)
        {
            if (month_cb.Text == "")
            {
                month_cb.Text = "Month";
        ...
        private void year_cb_Enter_1(object sender, EventArgs e)
        {
        ...
        private void year_cb_Leave_1(object sender, EventArgs e)
        {
            if (year_cb.Text == "")
            {
                year_cb.Text = "Year";
        ...
        public EditClick(int id, string name, int phone, string position, string gender, string age)
        {
            this.id = id;
            this.name = name;
            this.phone = phone;
